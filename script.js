...
function frame(title, bodyText, controlsHtml = '') {
...
function renderMainMenu() {
  ...
  return frame(APP_TITLE, body, controls);
}
...
function renderNewRoundPrompt() {
  ...
  return frame('新建回合', body, controls);
}
...
function renderNicknamePrompt() {
  ...
  return frame('输入昵称', body, controls);
}
...
function renderContinueList() {
  ...
  return frame('继续已有回合', body, controls);
}
...
function renderHistoryList() {
  ...
  return frame('查看历史回合', body, controls);
}
...
function renderRoundMenu() {
  ...
  return frame('回合菜单', body, controls);
}
...
function renderInputPapers() {
  ...
  return frame('输入纸条', body, controls);
}
...
function renderViewMyPapers() {
  ...
  return frame('查看自己的纸条', body, controls);
}
...
function renderDeletePaper() {
  ...
  return frame('删除纸条', body, controls);
}
...
function renderDrawPrompt() {
  ...
  if (!undrawnCount) {
    ...
    return frame('开始抽选', body, controls);
  }
...
function renderDrawContent() {
  ...
  return frame('本轮抽取结果', body, controls);
}
...
function renderDrawAuthors() {
  ...
  return frame('公布作者', body, controls);
}
